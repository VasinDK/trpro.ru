<div id="header-slider" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active"> <!-- Slider Item #1 -->
                <img src="{{ asset(env('THEME')) }}/img/slider/02.jpg" alt="...">
            ...
            <div class="item"> <!-- Slider Item #2 -->
                <img src="{{ asset(env('THEME')) }}/img/slider/03.jpg" alt="...">
                <div class="carousel-caption">
            ...
            <div class="item"> <!-- Slider Item #3 -->
                <img src="{{ asset(env('THEME')) }}/img/slider/01.jpg" alt="...">
                <div class="carousel-caption">
                ...
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-xs-6 col-sm-3 col-md-3">
                            <img src="{{ asset(env('THEME')) }}/img/partners/01.png" class="img-responsive" alt="...">
                        </div>
                        <div class="col-xs-6 col-sm-3 col-md-3">
                            <img src="{{ asset(env('THEME')) }}/img/partners/02.png" class="img-responsive" alt="...">
                        </div>
                        <div class="col-xs-6 col-sm-3 col-md-3">
                            <img src="{{ asset(env('THEME')) }}/img/partners/03.png" class="img-responsive" alt="...">
                        </div>
                        <div class="col-xs-6 col-sm-3 col-md-3">
                            <img src="{{ asset(env('THEME')) }}/img/partners/04.png" class="img-responsive" alt="...">
                        </div>
                    </div>
                </div>
